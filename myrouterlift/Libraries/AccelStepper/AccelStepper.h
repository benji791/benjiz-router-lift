...
public:
    ...
    /* Begin benji791 */
    long getBoundHigh() const;

    void setBoundHigh(long boundHigh);

    long getBoundLow() const;

    void setBoundLow(long boundLow);

    bool enabledBoundHigh();
    bool enabledBoundLow();
    void disableBoundHigh();
    void disableBoundLow();
    /* End benji791 */
...
protected:
    ...
    /* Begin benji791 */
    virtual void check4boundsAndAdaptTarget();
    virtual void redefineBounds(long newpos);
    /* End benji791 */
...
private:
    ...
    /* Begin benji791 */
    /// Manage two bounds for the stepper travel
    /// Those two bounds will be dynamic depending on 0
    long _bound_high;
    long _bound_low;
    bool _is_bound_low_initialized;
    bool _is_bound_high_initialized;
    /* End benji791 */
};
